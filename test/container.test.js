...
describe('Container', function() {
  ...
  describe('#create', function() {
    ...
    describe('patterns', function() {
      ...
      describe('unspecified-singleton', function () {

        it('should create one instance of unspecified singleton', function() {

          container.setSingletonByDefault(true);
          var obj1 = container.create('unspecified');
          var obj2 = container.create('unspecified');
          expect(obj1.constructor.name).to.equal('Unspecified')
          expect(obj1.constructor.name).to.equal('Unspecified')
          expect(obj1).to.be.equal(obj2);
          container.setSingletonByDefault(false);

        });

        it('should create multiple instances of singleton if singleton set to false', function() {

          container.setSingletonByDefault(true);
          var obj1 = container.create('specified');
          var obj2 = container.create('specified');
          expect(obj1.constructor.name).to.equal('Specified')
          expect(obj1.constructor.name).to.equal('Specified')
          expect(obj1).to.not.be.equal(obj2);
          container.setSingletonByDefault(false);
