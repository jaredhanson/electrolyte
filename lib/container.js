...
Container.prototype._registerModule = function(id, mod, sid) {
  ...
  case 'factory':
    debug('register factory %s %s', id, dependencies);
    this.register(new FactorySpec(id, dependencies, mod), sid);
    break;
  case 'constructor':
    debug('register constructor %s %s', id, dependencies);
    this.register(new ConstructorSpec(id, dependencies, mod), sid);
    break;
  case 'literal':
    debug('register literal %s', id);
    this.register(new LiteralSpec(id, [], mod), sid);
    break;
  }
}
