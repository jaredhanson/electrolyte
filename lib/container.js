...
Container.prototype.mock = function(id, mock_id) {
  this._loadModule(mock_id);

  var mock = this._o[mock_id];
  if (!mock) {
    throw new Error("Unable to create component '" + mock_id + "'");
  }

  this._o[ id ] = mock;
  delete this._o[ mock_id ];
};
