 ...
 * graph of objects as necessary.  Objects and their associatied specifications
 * are often colloquially referred to as simply "components."
 *
...
Container.prototype._loadSpec = function(id, cb) {
  ...
  return cb(new ComponentNotFoundError('Cannot find spec "' + id + '"'));
}
