...
Component.prototype.create = function(container) {
  ...
  if (!this.loaded) {
    ...
    for (var i = 0, len = deps.length; i < len; ++i) {
      ...
      // TODO: Clean up terminology re "suites"
      var loader = container._suites[this._sid].loader;
      var suite = container._suites[this._sid];
      if (typeof loader.scope == 'function') {
        inst = loader.scope(deps[i], inst, { prefix: suite.prefix, options: suite.options });
      }
      args.push(inst);
    }
  }
